...
public static class AbilityTweenAnimator
{
    public static IEnumerator CoroutineSwingTweenAnimation(AbilityController abilityController)
    {
        ...
        var adjustedWeaponPosition = new Vector3(abilityController.weaponAnimator.weapon.transform.position.x, abilityController.weaponAnimator.weapon.transform.position.y + 0.5f, 0.0f);
    ...
    public static IEnumerator CoroutineFullCircleTweenAnimation(AbilityController abilityController)
    {
        ...
        yield return forwardLungeTween.WaitForCompletion();
        abilityController.weaponAnimator.weapon.transform.GetChild(0).transform.localPosition = new Vector3(0.1f, 0.5f, 0);
